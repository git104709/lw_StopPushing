...
public class DateUtil {
    ...
    /**
     * 日期解析－将String<	类型的日期解析为Date型
     *
     * @param strDate 日期字串
     * @param pattern 格式化字串
     * @return 返回类型 Date 一个被格式化了的Date日期
     ...
     * 获取当前日期
     *
     * @return 返回类型 Date 返回类型 一个包含年月日的Date型日期
     */
     ...
     * 获取当前日期
     *
     * @return 返回类型 String 一个包含年月日的String型日期，但不包含时分秒。yyyy-MM-dd
     */
     ...
     * 获取当前时间
     *
     * @return 返回类型 String 一个包含年月日时分秒的String型日期。hh:mm:ss
     */
     ...
     * 获取当前完整时间
     *
     * @return 返回类型 String 一个包含年月日时分秒的String型日期。yyyy-MM-dd hh:mm:ss
     */
    ...
    /*
     * @Description:  获取date时间的前day天数的时间
     * @Param: [date, day]
     * @return: java.util.Date
     * @Author: wangjiacai
     * @Date: 2018/8/6
    ...
    /*
     * @Description: 获取当前时间的前day天数的时间
     * @Param:
     * @return:
     * @Author: wangjiacai
     * @Date: 2018/8/6
     */
    public static Date getPrevDay(int day){
    ...
    /*
     * @Description: 获取date时间的前hours小时的时间
     * @Param:
     * @return:
     * @Author: wangjiacai
     * @Date: 2018/8/6
     */
    public static Date getPrevHours(Date date,int hours){
        LocalDateTime localDateTime=dateToLocalDateTime(date);
    ...
    /*
     * @Description: 获取当前时间的前hours小时的时间
     * @Param:
     * @return:
     * @Author: wangjiacai
     * @Date: 2018/8/6
     */
    public static Date getPrevHours(int hours){
        LocalDateTime localDateTime=LocalDateTime.now();
        localDateTime=localDateTime.minusHours(hours);
        return localDateTimeToDate(localDateTime);
    }
    ...
    /*
     * @Description: 获取date时间的前minutes分钟的时间
     * @Param:
     * @return:
     * @Author: wangjiacai
     * @Date: 2018/8/6
     */
    public static Date getPrevMinutes(long minutes){
        LocalDateTime localDateTime=LocalDateTime.now();
    ...
    /*
     * @Description: 获取当前时间的前minutes分钟的时间
     * @Param:
     * @return:
     * @Author: wangjiacai
     * @Date: 2018/8/6
     */
    public static Date getPrevMinutes(Date date,long minutes){
        LocalDateTime localDateTime=dateToLocalDateTime(date);
        localDateTime=localDateTime.minusMinutes(minutes);
        return localDateTimeToDate(localDateTime);
    }
    ...
    /*
     * @Description: 获取当前时间的前seconds秒的时间
     * @Param:
     * @return:
     * @Author: wangjiacai
     * @Date: 2018/8/6
     */
    public static Date getPrevSeconds(long seconds){
        LocalDateTime localDateTime=LocalDateTime.now();
    ...
    /*
     * @Description: 获取当前时间的后seconds秒的时间
     * @Param:
     * @return:
     * @Author: wangjiacai
     * @Date: 2018/8/6
     */
    public static Date getAfterSeconds(long seconds){
        LocalDateTime localDateTime=LocalDateTime.now();
    ...
    /*
     * @Description: 获取date时间的前seconds秒的时间
     * @Param:
     * @return:
     * @Author: wangjiacai
     * @Date: 2018/8/6
     */
    public static Date getPrevSeconds(Date date,long seconds){
        LocalDateTime localDateTime=dateToLocalDateTime(date);
        localDateTime=localDateTime.minusSeconds(seconds);
        return localDateTimeToDate(localDateTime);
    }
    ...
    public static LocalDateTime getTodayZeroTime(){
        ...
        LocalDateTime date=LocalDateTime.of(now.getYear(),now.getMonthValue(),now.getDayOfMonth(),0,0,0);
        return date;
    }
     ...
     * 获取今日凌晨时间
     **/
    public static LocalDateTime getLocalDateTimeZeroTime(LocalDateTime localDateTime){
        LocalDateTime date=LocalDateTime.of(localDateTime.getYear(),localDateTime.getMonthValue(),localDateTime.getDayOfMonth(),0,0,0);
        return date;
    }
}